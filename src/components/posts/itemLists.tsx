...
import { ItemsArr } from "./types";

export default function ItemList({ items, isAdding }: { items: ItemsArr; isAdding: boolean }) {
  return (
    <div className="posts-inner-wrapper vertical-scroll">
      {isAdding ? (
